...
stream_tweets(
  "brexit",
  timeout = 60 * 60 * 24 * 7,
  file_name = "brexit.json",
  parse = FALSE
)


## read in the data as a tidy tbl data frame
brexit_stream <- parse_stream("brexit.json")

```



Finally, to pick up from where we left from tomorrow, let's save the data (replace the first argument 'brits' with your dataframe): 

```{r saving twitter data, include=TRUE, eval=FALSE, inspect=FALSE}

save(brits, file = "4britishleaders.RData")
```
